...
describe('StatusIndicator', () => {
  ...
  it('renders with custom message', () => {
    render(<StatusIndicator status="online" message="All systems operational" />);
  ...
  it('shows connection details for online status', () => {
    render(<StatusIndicator status="online" details={{ latency: '50ms', uptime: '99.9%' }} />);
  ...
  it('shows error details for error status', () => {
    render(<StatusIndicator status="error" details={{ error: 'Connection failed', code: 500 }} />);
