...
describe('DatePicker', () => {
  ...
  it('should handle disabled state', () => {
    render(
      <DatePicker value="2025-08-15" onChange={mockOnChange} disabled={true} />
    );
    const input = screen.getByDisplayValue('2025-08-15');
  ...
  it('should handle min date constraint', () => {
    render(
      <DatePicker value="2025-08-15" onChange={mockOnChange} min="2025-01-01" />
    );
    const input = screen.getByDisplayValue('2025-08-15');
  ...
  it('should handle max date constraint', () => {
    render(
      <DatePicker value="2025-08-15" onChange={mockOnChange} max="2025-12-31" />
    );
    const input = screen.getByDisplayValue('2025-08-15');
  ...
  it('should handle required field', () => {
    render(
      <DatePicker value="2025-08-15" onChange={mockOnChange} required={true} />
    );
    const input = screen.getByDisplayValue('2025-08-15');
  ...
  it('should handle clear functionality', () => {
    render(
      <DatePicker value="2025-08-15" onChange={mockOnChange} clearable={true} />
    );
